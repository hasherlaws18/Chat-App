      ...
      <div className="p-8 max-w-fit book-groups flex flex-wrap justify-center">
        <div className="p-2 m-2 max-w-xs bg-white border border-gray-400 shadow flex">
          <div className="book-card flex flex-col justify-center items-center">
            <a href="#">
              <img className="book-photo" src={BookCoding} alt="A random cropped image from Unsplash" style={{ maxHeight: '275px' }} />
            </a>
            <div className="book-card-info p-5 text-center">
              ...
              <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-800 hover:bg-yellow-900 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                Read more
        ...
        <div className="p-2 m-2 max-w-xs bg-white border border-gray-400 shadow flex">
          <div className="book-card flex flex-col justify-center items-center">
            <a href="#">
              <img className="book-photo" src={BookSelfHelp} alt="A random cropped image from Unsplash" style={{ maxHeight: '275px' }} />
            </a>
            <div className="book-card-info p-5 text-center">
              <a href="#">
        ...
        <div className="p-2 m-2 max-w-xs bg-white border border-gray-400 shadow flex">
          <div className="book-card flex flex-col justify-center items-center">
            <a href="#">
              <img className="book-photo" src={BookSciFi} alt="A random cropped image from Unsplash" style={{ maxHeight: '275px' }} />
            </a>
            <div className="book-card-info p-5 text-center">
              <a href="#">
        ...
        <div className="p-2 m-2 max-w-xs bg-white border border-gray-400 shadow flex">
          <div className="book-card flex flex-col justify-center items-center">
            <a href="#">
              <img className="book-photo" src={BookMystery} alt="A random cropped image from Unsplash" style={{ maxHeight: '275px' }} />
            </a>
            <div className="book-card-info p-5 text-center">
              <a href="#">
