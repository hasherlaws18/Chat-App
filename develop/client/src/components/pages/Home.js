      ...
      <section className="hero bg-yellow-100">
        <div className="grid max-w-screen-xl mx-auto lg:gap-8 xl:gap-0 py-8 lg:py-0 lg:grid-cols-12">
          <div className="bg-yellow-100 mr-auto place-self-center px-4 py-8 lg:col-span-6 lg:py-0">
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white border border-gray-900 rounded-lg bg-yellow-800 hover:bg-yellow-900 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              Login
              <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
              </svg>
            </a>
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-900 rounded-lg bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:ring-gray-100">
              Register
            </a>
          </div>
      ...
      <section className="features grid max-w-screen-xl mx-auto lg:gap-4 xl:gap-0 py-8 px-40 bg-yellow-100 lg:grid-cols-3">
        <div className="text-center p-4">
          ...
          <div className="py-1 px-10 hidden lg:mt-0 lg:col-span-6 lg:flex">
            <img src={FeatureOne} alt="hero-image" className="rounded-t-full" />
          </div>
        ...
        <div className="text-center p-4">
          ...
          <div className="py-1 px-10 hidden lg:mt-0 lg:col-span-6 lg:flex">
            <img src={FeatureTwo} alt="hero-image" className="rounded-t-full" />
          </div>
        ...
        <div className="text-center p-4">
          ...
          <div className="py-1 px-10 hidden lg:mt-0 lg:col-span-6 lg:flex">
            <img src={FeatureThree} alt="hero-image" className="rounded-t-full" />
          </div>
