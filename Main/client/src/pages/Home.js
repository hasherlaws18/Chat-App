      ...
      <section className="hero bg-yellow-100">
        <div className="grid max-w-screen-xl mx-auto lg:gap-8 xl:gap-0 py-8 lg:py-0 lg:grid-cols-12">
          <div className="bg-yellow-100 mr-auto place-self-center px-4 py-8 lg:col-span-6 lg:py-0">
            ...
            <a href="#login" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white border border-gray-900 rounded-lg bg-yellow-800 hover:bg-yellow-900 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              Login
